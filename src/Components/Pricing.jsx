                ...
                <div className="container px-5 py-8 mx-auto" bis_skin_checked={1}>
                    ...
                    >
                        ...
                        <div
                            ...
                            bis_skin_checked={1}
                        >
                            <button className="py-1 px-4 bg-yellow-500 text-white focus:outline-none">
                                Monthly
                            </button>
                    ...
                    <div className="flex flex-wrap -m-4" bis_skin_checked={1}>
                        <div className="p-4 xl:w-1/4 md:w-1/2 w-full" bis_skin_checked={1}>
                            <div
                        ...
                        <div className="p-4 xl:w-1/4 md:w-1/2 w-full" bis_skin_checked={1}>
                            <div
                                className="h-full p-6 rounded-lg border-2 border-yellow-500 flex flex-col relative overflow-hidden"
                                bis_skin_checked={1}
                            >
